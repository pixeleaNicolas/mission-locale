 ...
 * */
add_action('after_setup_theme','mission_locale_theme_setup');
function mission_locale_theme_setup(){
    /** tag-title **/
 ...
 */
function mission_locale_filter_login_head() {
...
add_action( 'login_head', 'mission_locale_filter_login_head', 100 );

function mission_locale_new_wp_login_url() {
	return home_url();
}
add_filter('login_headerurl', 'mission_locale_new_wp_login_url');